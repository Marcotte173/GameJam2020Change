...
public class Shock : Room
{
    public Shock()
    {
        ...
        visitedFlavor = "There are no lives left to save here, no lives left to take.";
    ...
    public void Interact()
    {
        ...
        if (!visited)
        {
            ...
            Write.Line(10, 10, "One holds 3 people and a timer that is quickly counting down.");
            Write.Line(10, 14, "The other holds 1 person with a paused timer.");
            Write.Line(10, 15, "The lever seems to control who will live and who will die");
